...
<body class="hold-transition sidebar-mini sidebar-collapse">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><i class="fas fa-truck"></i>&nbsp;&nbsp;Listado de Proveedores</h1>
                            <p>En esta sección se administrará todos los proveedores del sistema. <?php echo $_SESSION['activa'] ?></p>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="add-header">
                                <button type="button" data-toggle="modal" data-target="#proveedor_add" class="btn btn-warning">Agregar Proveedor&nbsp;&nbsp;<i class="fas fa-plus"></i></button>
                                <!-- Modal de agregar -->
                                <div class="modal fade modal_proveedor_add" id="proveedor_add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-truck"></i>&nbsp;&nbsp;Agregar Proveedor</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="alert alert-success alert-dismissible fade show" id="registro_exitoso" role="alert" style="display: none;">
                                                    ¡Felicidades! Has registrado con éxito el proveedor.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <form id="formProveedorAdd">
                                                    ...
                                                    <label class="form-label" style="width: 100%;">Nombre Comercial:</label>
                                                    <div class="input-group mb-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <button type="submit" class="btn btn-warning btn-block">Registrar Proveedor</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                <!-- Modal de actualizar -->
                                <div class="modal fade modal_proveedor_add" id="proveedor_update" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-sync"></i>&nbsp;&nbsp;Actualizar Proveedor</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="alert alert-success alert-dismissible fade show" id="update_exitoso" role="alert" style="display: none;">
                                                    ¡Felicidades! Has actualizado con éxito el proveedor.
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <form id="form_update">
                                                    ...
                                                    <input type="hidden" class="form-control" id="id_proveedorUp" name='id_proveedor' value=''>
                                                    <input type="hidden" class="form-control" name='accion' value='actualizar'>

                                                    <label class="form-label" style="width: 100%;">Nombre:</label>
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" id='nombreUp' name='nombre' placeholder="Nombre del proveedor">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fas fa-user text-warning"></span>
                                                            </div>
                                                    ...
                                                    <label class="form-label" style="width: 100%;">Nombre Comercial:</label>
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" id="nombre_comercialUp" name="nombre_comercial" placeholder="Nombre Comercial">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fas fa-phone text-warning"></span>
                                                            </div>
                            ...
                            <div class="table-responsive">
                                <table id="proveedores" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $tabla = $proveedorModelo->generar_tabla($proveedores);
    ...
    <script>
        $(document).ready(function() {
            // Detectar clic en cualquier botón con clase delete_proveedor

            $('.delete-class').on('click', function(e) {
                e.preventDefault(); // Prevenir el comportamiento por defecto del enlace
                console.log("delete")

                // Obtener el ID del proveedor desde el atributo data-id del botón que fue clickeado
                const proveedorId = $(this).data('id');

                // Mostrar alerta de confirmación con SweetAlert
                Swal.fire({
                    title: '¿Realmente quieres eliminar este proveedor?',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '../../controllers/proveedores/ProveedoresController.php', // Cambia esto al nombre de tu archivo controlador
                            type: 'POST',
                            data: {
                                accion: 'eliminar',
                                id_proveedor: proveedorId // Enviamos el ID del proveedor
                            },
                            success: function(response) {
                                ...
                                if (res.status === 'success') {
                                    Swal.fire(
                                        ...
                                        // Opcional: Recargar la página o eliminar la fila del proveedor
                                        location.reload(); // Recarga la página
                                        // O eliminar la fila directamente:
                                        // $(`[data-id="${proveedorId}"]`).closest('tr').remove();
                                    });
                                } else {
                                    Swal.fire(
                                        'Error',
                            ...
                            error: function(xhr, status, error) {
                                ...
                                Swal.fire(
                                    'Error',
                                    'Hubo un problema al intentar eliminar el proveedor.',
                                    'error'
                                );
        ...
        function actualizar() {
            ...
            $.ajax({
                type: "POST",
                url: "../../controllers/proveedores/ProveedoresController.php", // Cambia la URL al controlador correspondiente
        ...
        function actualizarModal(id_proveedor, nombre, rfc, direccion, telefono, nombre_contacto,
        telefono_contacto, nombre_comercial, email, razon_fiscal, estatus) {
            $('#proveedor_update').modal('show');
            ...
            $("#nombre_comercialUp").val(nombre_comercial);
            $("#emailUp").val(email);
        ...
        $(function() {
            ...
            $('#formProveedorAdd').validate({
                ...
                messages: {
                    ...
                    nombre_comercial: {
                        required: "Por favor, ingrese un nombre comercial."
                    },
                    email: {
